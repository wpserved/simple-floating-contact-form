...
<?php if($displayOptions->shouldDisplayPopup()): ?>
  <div id="sfcf_contact_popup" class="sfcf__main-widget">
    ...
    <style scoped>
      ...
      #sfcf_contact_popup .sfcf-form__success .sfcf-success__icon svg .check {
        stroke: <?php echo esc_html($this->notes['color_btn']); ?>;
      }

      #sfcf_contact_popup .sfcf-form__success .sfcf-success__icon svg .oval {
        fill: <?php echo esc_html($this->notes['color_success_icon']); ?>;
      }
    </style>
    <?php endif; ?>
...
<?php if ($displayOptions->shouldDisplayPopup()) : ?>
  ...
  <div id="sfcf" class="sfcf" data-sfcf>
    ...
    <main class="sfcf__main" data-sfcf-main>
      <button class="sfcf__button -close" data-sfcf-close></button>
