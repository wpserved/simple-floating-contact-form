...
class Display
{
  ...
  public function defaultData()
  {
    ...
    $this->notes['checkbox']      = get_option('sfcf-form-checkbox') ?: __('I have read and accept the Terms of Service & Privacy Policy*. I consent to processing my data by Indeon Sp. z o.o. for marketing purposes, including sending emails.', 'simple-floating-contact-form');
